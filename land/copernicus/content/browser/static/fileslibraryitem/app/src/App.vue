...
<style>
  ...
  */
  body.template-admin_files_library div#datatables-admin {
    background: #FFFFFF;
    padding: 20px;
    margin: 20px;
  }

  body.template-admin_files_library div#datatables-admin table#editor {
    background: #EEEEEE;
    border-spacing: 5px;
    color: #000000;
    margin: auto;
  ...
  body.template-admin_files_library div#datatables-admin table#editor tr,
  body.template-admin_files_library div#datatables-admin table#editor td,
  body.template-admin_files_library div#datatables-admin table#editor th {
    background: #FFFFFF;
    padding: 5px;
    margin: 5px;
    text-align: center;
  ...
  body.template-admin_files_library div#datatables-admin .dta-btn:hover {
    color: #819110;
    cursor: pointer;
  }

  body.template-admin_files_library div#datatables-admin div.table-preview-container {
    text-align: center;
    margin-top: 40px;
  }

  body.template-admin_files_library div#datatables-admin table.table-render-preview {
    margin: auto;
  }

  body.template-admin_files_library a {
    color: #A0B228;
    text-decoration: none;
  }

  body.template-admin_files_library a:hover {
    color: #819110;
  }

  body.template-admin_files_library i.fa.fa-times {
    color: #FDA42C !important;
  }

  body.template-admin_files_library i.fa.fa-times:hover {
    color: #F48D02 !important;
  }

  body.template-admin_files_library div.filters-container {
    clear: both;
    text-align: center;
  }

  body.template-admin_files_library div.filters-container ul.filters-list {
  ...
  body.template-admin_files_library ul.filters-list li {
    float: left;
    color: #A0B228;
    padding: 10px 20px;
    margin-right: 20px;
  ...
  body.template-admin_files_library ul.filters-list li.is-selected {
    border-bottom: 2px solid #A0B228;
  }

  body.template-admin_files_library ul.filters-list li:hover {
    cursor: pointer;
    color: #819110;
  }

  body.template-admin_files_library .fa.fa-2x {
    font-size: 25px;
  }

  body.template-admin_files_library span.not-editable {
    color: #BBBBBB;
  }

  body.template-admin_files_library div.col-lg-3[data-diazo="land-secondary-column"] {
    display: none;
  }

  body.template-admin_files_library div.main-content > div.col-lg-9 {
    width: 100%;
  }
</style>
